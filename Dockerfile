...
ARG APP_VERSION
LABEL org.opencontainers.image.title="inaturalist-mcp-server"
LABEL org.opencontainers.image.description="Search wildlife sightings, read identification threads, rank species by area, chart phenology, and find look-alike taxa from iNaturalist via MCP. STDIO or Streamable HTTP."
LABEL org.opencontainers.image.licenses="Apache-2.0"
LABEL org.opencontainers.image.version="${APP_VERSION}"
LABEL org.opencontainers.image.source="https://github.com/cyanheads/inaturalist-mcp-server"
...
RUN mkdir -p /var/log/inaturalist-mcp-server && chown -R bun:bun /var/log/inaturalist-mcp-server
...
ENV LOGS_DIR="/var/log/inaturalist-mcp-server"
